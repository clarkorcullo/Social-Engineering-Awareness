...
class ModuleManagerService:
    ...
    def get_knowledge_check_questions(module_number: int, attempt_number: int = 1) -> List[Dict[str, Any]]:
        ...
        # For final assessment, use all 25 questions, for regular modules use 5
        if module_number == 8:  # Final Assessment
    ...
    def get_all_modules_info() -> List[Dict[str, Any]]:
        ...
        for module_num in range(1, 9):  # Modules 1-8
            ...
            if content:
                modules_info.append({
                    ...
                    'is_final_assessment': module_num == 8
                })
